console.log("5) загрузка main.js");
$(function(){
// ------------------------------------------------------------------------------------------------------------------------
...
// ------------------------------------------------------------------------------------------------------------------------
//Отображение карты в зависимости от устройства, с которого совершен заход на сайт
if(isMobileOrTablet()){
	console.log("7) Мобильное устройство");
	let map = '<a href="https://yandex.ru/maps/?um=constructor%3A9f047d42b75fa1b53c3d618d349229a813d509d8403a7682b0be4b042abdfb94&amp;source=constructorStatic" target="_blank"><img src="https://api-maps.yandex.ru/services/constructor/1.0/static/?um=constructor%3A9f047d42b75fa1b53c3d618d349229a813d509d8403a7682b0be4b042abdfb94&amp;width=600&amp;height=400&amp;lang=ru_RU" alt="" style="border: 0;" /></a>';
	$(map).appendTo('#block-map')
}else{
	console.log("7) ПК");
	let map = '<script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A92d6df3c69c26e50829257ce16d4e022656c14db788d96923702e86b5ec9f7a9&amp;width=100%25&amp;height=400&amp;lang=ru_RU&amp;scroll=true"><//script>';
	$(map).appendTo('#block-map')
};
...
// ------------------------------------------------------------------------------------------------------------------------
//Проверка устройства, с которого заходят на сайт
function isMobile() {
	var check = false;
...
console.log("6) конец загрузки main.js");
